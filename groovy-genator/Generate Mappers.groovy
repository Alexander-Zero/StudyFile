...
def generate(table, dir) {
    ...
    //设置为utf-8
    new File(dir, className + "Mapper.java").withPrintWriter("utf-8") { out -> generate(out, className, table.getName()) }
}
...
def generate(out, className, tableName) {
    ...
    out.println ""
    out.println ""
    out.println "public class ${className}${mapperType} extends BaseMapper<${className}${modelType}> {"
    out.println ""
